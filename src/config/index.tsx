...
import { base, mainnet, plumeMainnet, polygon, worldchain } from "viem/chains";

import { Logo } from "./components/Logo";
import { AppConfig } from "./types";

export const SUPPORTED_CHAIN_IDS = [mainnet.id, polygon.id, base.id, worldchain.id, plumeMainnet.id] as const;
...
export const APP_CONFIG: AppConfig = {
  ...
  chainConfig: {
    ...
    [plumeMainnet.id]: {
      chain: plumeMainnet,
      rpcUrls: [process.env.NEXT_PUBLIC_PLUME_RPC_URL_1!, process.env.NEXT_PUBLIC_PLUME_RPC_URL_2!],
    },
  },
  appMetadata: {
  ...
  whitelistedVaults: {
    ...
    [plumeMainnet.id]: [
      getAddress("0xc0df5784f28046d11813356919b869dda5815b16"), // pUSD
    ],
  },
  actionParameters: {
